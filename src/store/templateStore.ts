...
const seedTemplates: EmailTemplate[] = [
  { id: 'tpl-001', name: 'Primer contacto', subject: 'Encantado de conectar, {{firstName}}', body: 'Hola {{firstName}},\n\nMi nombre es del equipo comercial de demo. Me gustaría explorar si podríamos colaborar.\n\nUn saludo,\nDemo Team', category: 'intro', variables: ['{{firstName}}', '{{company}}'], createdAt: '2025-01-15T10:00:00Z', updatedAt: '2025-01-15T10:00:00Z', usageCount: 24 },
  { id: 'tpl-002', name: 'Seguimiento reunión', subject: 'Resumen de nuestra reunión - {{dealTitle}}', body: 'Hola {{firstName}},\n\nGracias por tu tiempo. Te enviaré la propuesta en los próximos días.\n\nUn saludo,\nDemo Team', category: 'follow_up', variables: ['{{firstName}}', '{{company}}', '{{dealTitle}}'], createdAt: '2025-01-20T10:00:00Z', updatedAt: '2025-01-20T10:00:00Z', usageCount: 18 },
  { id: 'tpl-003', name: 'Envío de propuesta', subject: 'Propuesta comercial - {{dealTitle}}', body: 'Hola {{firstName}},\n\nAdjunto encontrarás la propuesta comercial para {{dealTitle}}.\n\nUn saludo,\nDemo Team', category: 'proposal', variables: ['{{firstName}}', '{{company}}', '{{dealTitle}}', '{{dealValue}}'], createdAt: '2025-02-01T10:00:00Z', updatedAt: '2025-02-01T10:00:00Z', usageCount: 12 },
  { id: 'tpl-004', name: 'Cierre de deal', subject: 'Siguientes pasos para cerrar {{dealTitle}}', body: 'Hola {{firstName}},\n\nQuería hacer seguimiento sobre la propuesta de {{dealTitle}}.\n\nUn saludo,\nDemo Team', category: 'closing', variables: ['{{firstName}}', '{{company}}', '{{dealTitle}}'], createdAt: '2025-02-10T10:00:00Z', updatedAt: '2025-02-10T10:00:00Z', usageCount: 8 },
  { id: 'tpl-005', name: 'Nurturing - Contenido de valor', subject: '{{firstName}}, un recurso que puede interesarte', body: 'Hola {{firstName}},\n\nHemos publicado un estudio relevante para {{company}}.\n\nUn saludo,\nDemo Team', category: 'nurture', variables: ['{{firstName}}', '{{company}}'], createdAt: '2025-02-15T10:00:00Z', updatedAt: '2025-02-15T10:00:00Z', usageCount: 15 },
]
