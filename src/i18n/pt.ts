...
export const pt: Translations = {
  ...
  settings: {
    ...
    webhooksTitle: 'Webhooks de saída',
    webhooksIntro:
      'Envia POST HTTPS assinados quando negócios, contatos, empresas ou atividades mudam. Use filtros como * ou deal.* para controlar os eventos.',
    webhooksRequiresSupabase: 'Webhooks exigem um projeto Supabase configurado.',
    webhooksCronHint:
    ...
    webhooksCreateSection: 'Nova assinatura',
    webhooksName: 'Nome',
    ...
    webhooksCreate: 'Criar webhook',
    webhooksCreated: 'Webhook criado',
    webhooksLoadError: 'Não foi possível carregar os webhooks',
    webhooksListTitle: 'Assinaturas',
    webhooksListEmpty: 'Ainda não há webhooks.',
