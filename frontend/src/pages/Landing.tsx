  ...
  return (
    <div className="min-h-screen bg-surface-0 text-fg overflow-x-hidden">
      ...
      <section id="stack" className="max-w-6xl mx-auto px-6 py-12 pb-24">
        <div className="rounded-2xl border border-velo-500/20 bg-gradient-to-br from-velo-900/30 via-surface-0/40 to-surface-0/20 p-10 sm:p-14 relative overflow-hidden">
