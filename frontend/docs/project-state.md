...
| Pipedrive parity, webhooks/API spec, group killer gaps | [`master-pipedrive-comparison.md`](./master-pipedrive-comparison.md) | Benchmark + v1 webhook acceptance criteria + interview template. |
...
| **Monorepo adoption documentation** | Migrated from separate frontend and API repos to a single monorepo on 2026-05-18. Paths, references, and deployment docs updated. | [`../README.md`](../README.md) · [`../api/README.md`](../api/README.md) · [`./deployment-spa-and-env.md`](./deployment-spa-and-env.md) · [`docker-compose.yml`](../docker-compose.yml). |
| **Pipedrive / group integration parity** (outbound webhooks shipped; public REST phase 1 + Settings UI completion in flight) | Outbound webhooks + replay in `api/webhook_subscriptions` tables; public API keys / read API / lead capture via `/public/v1/leads` and `/integrations/` routes — see [`public-api-phase1.md`](./public-api-phase1.md), [`lead-capture-public-endpoint.md`](./lead-capture-public-endpoint.md), [`master-pipedrive-comparison.md`](./master-pipedrive-comparison.md), [`api/README.md`](../../api/README.md). |
