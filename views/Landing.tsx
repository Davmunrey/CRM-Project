...
function BrowserFrame({ children, url = 'app.propel.io/pipeline' }: { children: React.ReactNode; url?: string }) {
  return (
    <div
      style={{
        borderRadius: 14,
...
function KanbanMockup() {
  ...
  return (
    <BrowserFrame url="app.propel.io/pipeline">
...
function InboxMockup() {
  ...
  return (
    <BrowserFrame url="app.propel.io/inbox">
...
function SequenceMockup() {
  ...
  return (
    <BrowserFrame url="app.propel.io/sequences/outbound-q4">
      <div style={{ display: 'flex', height: 360 }}>
    ...
    >
      ...
      <div style={{ background: '#13141f', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ flex: 1, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, height: 22, display: 'flex', alignItems: 'center', paddingLeft: 10 }}>
          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.25)', fontFamily: 'monospace' }}>app.propel.io/pipeline</span>
        </div>
      </div>
      {/* App */}
...
const PRODUCT_PANELS: ProductPanel[] = [
  ...
  },
  {
    ...
    body: 'Native Gmail sync brings every conversation into Propel — read, reply and track opens, tied to the right deal automatically.',
...
export function Landing() {
  ...
  const TESTIMONIALS = [
    { quote: 'We replaced three tools with Propel and finally own our pipeline data. The forecast is actually trusted now.', name: 'Sales lead', role: 'B2B SaaS · team of 12', initial: 'S' },
      ...
      <section className="py-28" style={{ borderTop: `1px solid ${C.line}` }}>
        <Reveal>
          <div className="text-center mb-12 px-6">
            ...
            <p className="max-w-xl mx-auto" style={{ color: C.muted }}>What sales leaders say after switching to Propel.</p>
          </div>
        </Reveal>
