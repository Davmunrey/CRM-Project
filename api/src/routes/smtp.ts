  ...
  app.post('/test', async (req, reply) => {
    ...
    try {
      await transporter.sendMail({
        ...
        to: d.to,
        subject: 'Velo CRM — SMTP test',
        text: 'This is a test email from your Velo CRM SMTP configuration.',
        html: '<p>This is a test email from your <strong>Velo CRM</strong> SMTP configuration.</p>',
      })
      await db`
