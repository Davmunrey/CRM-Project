...
const Forecast = lazy(() => import('@/views/Forecast').then((m) => ({ default: m.Forecast })))
const ManagerDashboard = lazy(() => import('@/views/ManagerDashboard').then((m) => ({ default: m.ManagerDashboard })))
const Contacts = lazy(() => import('@/views/Contacts').then((m) => ({ default: m.Contacts })))
const Leads = lazy(() => import('@/views/Leads').then((m) => ({ default: m.Leads })))
const Tickets = lazy(() => import('@/views/Tickets').then((m) => ({ default: m.Tickets })))
const Companies = lazy(() => import('@/views/Companies').then((m) => ({ default: m.Companies })))
const Deals = lazy(() => import('@/views/Deals').then((m) => ({ default: m.Deals })))
const Activities = lazy(() => import('@/views/Activities').then((m) => ({ default: m.Activities })))
const Settings = lazy(() => import('@/views/Settings').then((m) => ({ default: m.Settings })))
const SettingsIntegrations = lazy(() =>
  import('@/views/SettingsIntegrations').then((m) => ({ default: m.SettingsIntegrations })),
)
const Inbox = lazy(() => import('@/views/Inbox').then((m) => ({ default: m.Inbox })))
const EmailTemplates = lazy(() => import('@/views/EmailTemplates').then((m) => ({ default: m.EmailTemplates })))
const Calendar = lazy(() => import('@/views/Calendar').then((m) => ({ default: m.Calendar })))
const Sequences = lazy(() => import('@/views/Sequences').then((m) => ({ default: m.Sequences })))
const ContactDetail = lazy(() => import('@/views/ContactDetail').then((m) => ({ default: m.ContactDetail })))
const CompanyDetail = lazy(() => import('@/views/CompanyDetail').then((m) => ({ default: m.CompanyDetail })))
const FollowUps = lazy(() => import('@/views/FollowUps').then((m) => ({ default: m.FollowUps })))
const AuditLog = lazy(() => import('@/views/AuditLog').then((m) => ({ default: m.AuditLog })))
const SalesGoals = lazy(() => import('@/views/SalesGoals').then((m) => ({ default: m.SalesGoals })))
...
const OrgSetup = lazy(() => import('@/views/OrgSetup').then((m) => ({ default: m.OrgSetup })))
const OrgAccessRequired = lazy(() => import('@/views/OrgAccessRequired').then((m) => ({ default: m.OrgAccessRequired })))
const AcceptInvite = lazy(() => import('@/views/AcceptInvite').then((m) => ({ default: m.AcceptInvite })))
const TeamManagement = lazy(() => import('@/views/TeamManagement').then((m) => ({ default: m.TeamManagement })))
...
const PipelineTimeline = lazy(() => import('@/views/PipelineTimeline').then((m) => ({ default: m.PipelineTimeline })))
const Automations = lazy(() => import('@/views/Automations').then((m) => ({ default: m.Automations })))
const Products = lazy(() => import('@/views/Products').then((m) => ({ default: m.Products })))
const GmailCallback = lazy(() => import('@/views/GmailCallback').then((m) => ({ default: m.GmailCallback })))
const PublicLeadForm = lazy(() => import('@/views/PublicLeadForm').then((m) => ({ default: m.PublicLeadForm })))
const PublicBooking = lazy(() => import('@/views/PublicBooking').then((m) => ({ default: m.PublicBooking })))
const BookingPages = lazy(() => import('@/views/BookingPages').then((m) => ({ default: m.BookingPages })))
