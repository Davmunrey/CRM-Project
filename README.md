...
Browser (React SPA)
  ...
  │                     └─ __veloDbChange(table) — org-scoped rooms, JWT-verified
  │
...
npm install
npm run db:migrate
npm run db:seed                               # seeds admin@velo.local / Admin1234!
...
| `api` | `gitea.apps.privateprompt.tech/clovrlabs/velo-api:latest` |
...
Images: `gitea.apps.privateprompt.tech/clovrlabs/velo-crm:latest` and `velo-api:latest`.
