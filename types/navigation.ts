...
export type SidebarBuiltinItemId =
  ...
  | 'calendar' | 'activities' | 'followUps' | 'goals' | 'managerDashboard' | 'notifications' | 'inbox' | 'reports' | 'forecast'
  | 'templates' | 'sequences'
...
export type SidebarIconKey =
  ...
  | 'file-text' | 'list-ordered' | 'users-round' | 'package' | 'workflow' | 'settings' | 'scroll-text' | 'layout-grid'
