...
**Product spec (Velo outbound webhooks v1 + parity vs Pipedrive):** [`docs/master-pipedrive-velo-comparison.md`](../../docs/master-pipedrive-velo-comparison.md).
